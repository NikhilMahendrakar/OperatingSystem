...
// Variable to store the number of system calls called
int system_calls_counter = 0;
...
syscall(void)
{
  ...
  // Increase the counter whenever a system call is called
...
int 
system_calls_count(void) 
{
  return system_calls_counter;
}
